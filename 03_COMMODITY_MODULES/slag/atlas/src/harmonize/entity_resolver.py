#!/usr/bin/env python3
"""
Entity Resolution Module — Slag / GGBFS
==========================================
Performs fuzzy matching of steel mill and slag processor names using rapidfuzz.
...
class EntityResolver:
    """Handles fuzzy matching and entity resolution for slag/steel producer names."""
