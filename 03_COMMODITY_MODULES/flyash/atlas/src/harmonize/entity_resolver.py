#!/usr/bin/env python3
"""
Entity Resolution Module — Fly Ash / CCP
===========================================
Performs fuzzy matching of coal plant, ash processor, and cement consumer names
using rapidfuzz. Matches EPA FRS facility names against known producers from
...
class EntityResolver:
    """Handles fuzzy matching and entity resolution for fly ash producer/processor names."""
