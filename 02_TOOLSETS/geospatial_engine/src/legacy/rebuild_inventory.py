...
def read_geospatial_csv():
    ...
    datasets = []
    csv_path = Path(r"G:\My Drive\LLM\sources_data_maps\_user_notes\_drafts_source_library\Master_GIS_Dataset_Index (2).csv")
...
def read_eia_datasets():
    ...
    datasets = []
    json_path = r"G:\My Drive\LLM\sources_data_maps\eia_datasets_complete.json"
...
def read_fgdc_datasets():
    ...
    datasets = []
    json_path = r"G:\My Drive\LLM\sources_data_maps\fgdc_datasets_complete.json"
...
def read_maritime_datasets():
    ...
    datasets = []
    json_path = r"G:\My Drive\LLM\sources_data_maps\maritime_usace_noaa_datasets.json"
...
def read_chrome_bookmark_datasets():
    ...
    datasets = []
    json_path = r"G:\My Drive\LLM\sources_data_maps\chrome_bookmarks_datasets.json"
...
def main():
    ...
    # Write to CSV
    output_path = Path(r"G:\My Drive\LLM\sources_data_maps\_build_documents\sources_inventory.csv")
