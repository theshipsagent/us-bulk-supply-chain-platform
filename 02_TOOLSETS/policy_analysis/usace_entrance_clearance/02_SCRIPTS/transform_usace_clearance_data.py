"""
Transform USACE Clearance Data (Outbound/Exports) v3.0.0
...
def transform_clearance_data(input_file, output_file, dict_path, test_mode=False):
    """Transform USACE clearance data"""

    print("=" * 80)
    print("USACE Clearance Data Transformation v3.0.0 (Outbound/Exports)")
    print("=" * 80)
    print()
...
def main():
    ...
    # Paths
    INPUT_FILE = project_root / "00_DATA" / "00.01_RAW" / "Entrances_Clearances_2023_2023_Outbound.csv"
    OUTPUT_FILE = project_root / "00_DATA" / "00.02_PROCESSED" / "usace_2023_outbound_clearance_transformed_v3.0.0.csv"
    ...
    df_final = transform_clearance_data(INPUT_FILE, OUTPUT_FILE, DICT_PATH, test_mode=False)
